...
dotfs upload <file_path> <directory> --access <public|private> --id <link_id?>
...
dotfs get <file_identifier> <output_path?> --metadata --link
...
dotfs access <file_identifier> <public|private>
